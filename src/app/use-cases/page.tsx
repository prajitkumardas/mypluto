      ...
      <div className="mt-10 grid gap-5 md:grid-cols-3">
        {useCases.map((useCase) => (
          <Link
            ...
            key={useCase.slug}
          >
            <h2 className="font-heading text-3xl font-bold text-neutral-900">{useCase.title}</h2>
            <p className="mt-3 text-sm leading-6 text-neutral-700">{useCase.query}</p>
            <span className="mt-6 inline-flex items-center gap-2 text-sm font-bold text-violet-600">
