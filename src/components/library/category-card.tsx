  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-4">
        <h3 className="type-h4 text-neutral-900 group-hover:text-violet-600">
          {category.name}
        </h3>
      ...
      <p className="number mt-2 type-label-md text-neutral-500">
      ...
      <span className="mt-auto pt-5 type-label-md text-violet-600">
        View tools
      </span>
    </Link>
  );
