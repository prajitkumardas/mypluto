...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        "display-xl": ["var(--text-display-xl)", { lineHeight: "var(--leading-display-xl)", letterSpacing: "var(--tracking-display-xl)", fontWeight: "var(--font-weight-bold)" }],
        "display-lg": ["var(--text-display-lg)", { lineHeight: "var(--leading-display-lg)", letterSpacing: "var(--tracking-display-lg)", fontWeight: "var(--font-weight-bold)" }],
        h1: ["var(--text-h1)", { lineHeight: "var(--leading-h1)", letterSpacing: "var(--tracking-h1)", fontWeight: "var(--font-weight-bold)" }],
        h2: ["var(--text-h2)", { lineHeight: "var(--leading-h2)", letterSpacing: "var(--tracking-h2)", fontWeight: "var(--font-weight-bold)" }],
        h3: ["var(--text-h3)", { lineHeight: "var(--leading-h3)", letterSpacing: "var(--tracking-h3)", fontWeight: "var(--font-weight-bold)" }],
        h4: ["var(--text-h4)", { lineHeight: "var(--leading-h4)", letterSpacing: "var(--tracking-h4)", fontWeight: "var(--font-weight-bold)" }],
        h5: ["var(--text-h5)", { lineHeight: "var(--leading-h5)", letterSpacing: "var(--tracking-h5)", fontWeight: "var(--font-weight-bold)" }],
        h6: ["var(--text-h6)", { lineHeight: "var(--leading-h6)", letterSpacing: "var(--tracking-h6)", fontWeight: "var(--font-weight-bold)" }],
